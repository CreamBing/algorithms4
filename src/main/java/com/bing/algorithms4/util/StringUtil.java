...
public class StringUtil {
    ...
    public static String getString(Object value) {
        return (value == null || "null".equals(value) || "MULL".equals(value)|| "NULL".equals(value))? "" : value.toString();
    }
    public static String filter(Object value) {
        return (value == null || "null".equals(value) || "MULL".equals(value)|| "NULL".equals(value)||"".equals(value)||value.equals(""))? "" : value.toString();
    }
    ...
    public static boolean isEmpty(String s) {
        return (s == null || "".equals(s.trim()) || "null".equals(s.trim())||"NULL".equals(s.trim()));
    }
	...
	public static String randam5Num() {
		Random rd = new Random();
		StringBuilder sb = new StringBuilder();
		for (int i = 0; i < 5; i++) {
			sb.append(rd.nextInt(10));
		}
		return StringUtil.getString(sb.toString());
	}
	/**
	 * 截取指定分割符之前的字符串
	 * @param dataString
	 ...
	 * @return
	 */
	public static String subStringBefore(String dataString, String separator) {
		return isEmpty(dataString)||isEmpty(separator) ? dataString:dataString.substring(0, dataString.lastIndexOf(separator));
	}
	/**
	 * 截取指定分割符之后的字符串
	 * @param dataString
	 ...
	 * @return
	 */
	public static String subStringAfter(String dataString, String separator) {
		return isEmpty(dataString)||isEmpty(separator) ? dataString:dataString.substring(dataString.lastIndexOf(separator)+1, dataString.length());
	}
	 ...
	 * @return
	 */
	public static String[] sblitString(String dataString, String separator) {
		return isEmpty(dataString)||isEmpty(separator) ? null:dataString.split(separator);
	}
	/**
	 * 根据指定的分隔符 组织字符串
	 * @param data
	 ...
	 * @return
	 */
	public static String oragnizeStringBySeparator(String[] data, String separator){
		String resultStr="";
		for(int i=0;i<data.length;i++){
			resultStr+=data[i]+separator;
		}
		return  resultStr;
	}
	public static void main(String[] args) {
		if(StringUtil.isEmpty(StringUtil.filter(""))){
